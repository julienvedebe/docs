...
<Steps>
  ...
  <Step title="Authenticate your request">
    The **myConnectedFleet** API uses **Basic HTTP Authentication**.  Encode your username and password in **Base64**, and include them in the `Authorization` header of your HTTP request:
