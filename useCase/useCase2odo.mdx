...
division	Group or business unit (optional)

💡 Tip: Use consistent vehicle names and registration numbers that match your leasing provider’s records.
This ensures that exported mileage data aligns automatically with your external systems and avoids manual reconciliation.
