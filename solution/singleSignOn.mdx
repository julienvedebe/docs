...
The **myConnectedFleet portal** supports **Single Sign On** (SSO) using the **OpenID Connect** standard.
...
To enable SSO for a user, use the API to set a value for the **external identifier** against the user. 
