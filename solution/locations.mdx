...
A Point of Interest (POI) is a map location that has been given a name and marked by a geo-fence boundary. By creating POI locations, it is possible to report when a resource has arrived at or departed from that named location. 
...
### Radius
- A geofence for the location is a circle.
