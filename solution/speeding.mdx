...
The **myConnectedFleet** platform is able to determine if a vehicle is speeding and will create a **speeding episode** whenever both of the following conditions are satisfied.
