...
**myConnectedFleet ** allows for the creation of a group hierarchy. You have only one primary group hierarchy, but you can create many subgroups within the hierarchy to meet your reporting/tracking requirements.
