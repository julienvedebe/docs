...
**myConnectedFleet** allows for the creation of a group hierarchy. You can have only one primary group hierarchy, but you can create as many subgroups within the hierarchy to meet your reporting/tracking requirements.
...
- All vehicles or drivers in the company (e.g. MICHELIN)