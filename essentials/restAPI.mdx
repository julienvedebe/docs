...
These are the main features available in the **MICHELIN Connected Fleet API**.

## Telematics

You can get GPS and vehicle information to synchronize this telematics data into your own applications. Get the latest GPS location of a vehicle, input values, fuel consumption and details of vehicle faults.
...
The Locations API allows you to manage known locations for use in driver timesheets, reports, alerts and more. You can create, read, update, and delete locations and configure their geofences.
...
The features of the **MICHELIN Connected Fleet** portal that a user can access are dependent on their assigned role. You can define the features available for a role and can create as many roles as needed.
...
Only read operations are available through the API for inputs. See the [**Inputs**](/solution/inputs) API for more details.