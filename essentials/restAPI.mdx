...
The features of the **mConnectedFleet portal** that a user can access are dependent on their assigned role. You can define the features available for a role and can create as many roles as needed.
