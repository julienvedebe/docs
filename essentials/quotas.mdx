---
title: "Quotas & limits"
description: "To protect the MICHELIN Connected Fleet API from receiving more operations that it can handle, a quota system, request limits and asset day limits have been implemented.  "
icon: "map"
---
...
Additional quota limits, restrictions and changes to quota limits may be implemented in future releases of the **MICHELIN Connected Fleet API**.