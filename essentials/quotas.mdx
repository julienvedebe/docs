...
To protect the MICHELIN Connected Fleet API from receiving more operations that it can handle, a quota system, request limits and asset day limits have been implemented.  
