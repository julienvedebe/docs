...
To protect the **myConnectedFleet** API from receiving more operations that it can handle, a quota system, request limits and asset day limits have been implemented.  
...
Additional quota limits, restrictions and changes to quota limits may be implemented in future releases of the **myConnectedFleet API**.